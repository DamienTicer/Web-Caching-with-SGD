...
# Load request data
df = pd.read_csv("interim_data/request_data.csv")
...
df.to_csv("interim_data/processed_request_data.csv", index=False)
print("Processed dataset saved to interim_data/processed_request_data.csv")